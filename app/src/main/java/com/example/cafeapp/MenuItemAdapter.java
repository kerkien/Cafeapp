...
public class MenuItemAdapter extends BaseAdapter {
    ...
    private boolean isPreview; // 👈 NEW FLAG

    // ✅ Constructor with preview flag
    public MenuItemAdapter(Context context, ArrayList<MenuItem> menuItems, boolean isPreview) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            // 👇 Use preview layout if needed
            int layoutId = isPreview ? R.layout.menuitempreview : R.layout.menu_item_layout;
        ...
        // ✅ Only handle Edit/Delete in non-preview mode
        if (!isPreview) {
